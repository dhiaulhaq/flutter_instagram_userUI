...
class _ProfileState extends State<Profile> with TickerProviderStateMixin{
  ...
  final urlProfile = 'https://avatars0.githubusercontent.com/u/19872458?s=460&v=4';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Row(
          children: <Widget>[
            Text('dhiaulhaq', style: TextStyle(color: Colors.black)),
            ...
            child: TabBarView(
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Center(
                    child: Text('github.com/dhiaulhaq'),
                  ),
                ),
              ],
            ),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Text(
            'Migrating to another beyond!',
          ),
          Text(
            'https://twitter.com/DhiaulhaqDev777',
